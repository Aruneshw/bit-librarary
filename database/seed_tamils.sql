...
Reed', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 4),
  ('faca0000-0000-0000-0000-000000000005', 'a1000000-0000-0000-0000-000000000006', 'How were the woven garments sold during the Sangam period?', 'Garments were sold in local markets and exported through ports to foreign countries.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 5),
  ('faca0000-0000-0000-0000-000000000006', 'a1000000-0000-0000-0000-000000000006', 'Where were dye vats discovered?', 'Dye vats were discovered at Arikamedu near Puducherry.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 6),
  ('faca0000-0000-0000-0000-000000000007', 'a1000000-0000-0000-0000-000000000006', 'Which type of pottery was popular in Madurai?', 'Glossy black pottery was popular in Madurai.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 7),
  ('faca0000-0000-0000-0000-000000000008', 'a1000000-0000-0000-0000-000000000006', 'What is the specialty of Velloor Karigiri pottery?', 'Velloor Karigiri pottery is famous for its fine finish, durability and artistic beauty.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 8),
  ('faca0000-0000-0000-0000-000000000009', 'a1000000-0000-0000-0000-000000000006', 'What are the two divisions of pottery?', 'The two divisions are:

Glossy pottery
Unglossed pottery', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 9),
  ('faca0000-0000-0000-0000-000000000010', 'a1000000-0000-0000-0000-000000000006', 'What is meant by craft work on pottery?', 'Decorative artistic designs made on pottery are called pottery craft work.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 10),
  ('faca0000-0000-0000-0000-000000000011', 'a1000000-0000-0000-0000-000000000006', 'What are the uses of pottery in educational art?', 'Pottery is used for:

Teaching art and creativity
Developing practical skills
Craft training', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 11),
  ('faca0000-0000-0000-0000-000000000012', 'a1000000-0000-0000-0000-000000000006', 'What are the uses of pottery in medical science?', 'Pottery is used to prepare medical containers, storage vessels and laboratory equipment.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 12),
  ('faca0000-0000-0000-0000-000000000013', 'a1000000-0000-0000-0000-000000000006', 'What materials are found in black and red ware?', 'Black and red ware contains:

Bowls
Pots
Plates
Storage vessels', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 13),
  ('faca0000-0000-0000-0000-000000000014', 'a1000000-0000-0000-0000-000000000006', 'What symbols are found on pottery?', 'Common symbols include:
...
Geometric marks', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 14),
  ('faca0000-0000-0000-0000-000000000015', 'a1000000-0000-0000-0000-000000000006', 'In which part of Tamil Nadu were pots with the Swastika symbol found?', 'Such pottery was found at Kodumanal and Keeladi excavation sites.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 15),
  ('faca0000-0000-0000-0000-000000000016', 'a1000000-0000-0000-0000-000000000006', 'During which period did people use symbols to express their thoughts?', 'People used symbols during the Prehistoric Period before the development of writing.', NULL, '22GE201 - Tamils and Technology', 'Unit 1 - 2-Mark', 16),
  ('faca0000-0000-0000-0000-000000000017', 'a1000000-0000-0000-0000-000000000006', 'How was the weaving industry during the Sangam period? Explain the various stages involved in making clothing.', 'The weaving industry was one of the most important occupations during the Sangam age. Tamil weavers produced fine cotton and silk fabrics that were famous throughout India and abroad.
