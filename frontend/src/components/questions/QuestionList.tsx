...
export default function QuestionList({ questions, onSelect, onDelete }: QuestionListProps) {
              ...
              <div className="space-y-2 pl-2 border-l border-white/5">
                {groupQs.map((q, index) => (
                  ...
                  >
                    ...
                    {/* Question Title */}
                    <span className="flex-1 font-exo2 text-sm text-text-white/90 truncate translate pr-2">
                    ...
                    {onDelete && (
                      <button
                        ...
                        className="p-1.5 rounded bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white transition-colors z-10 mx-2"
