...
export default function BroadcastBanner() {
  ...
  if (!isAuthenticated || !isVisible || !current || dismissed) return null;
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div className="flex items-center gap-1.5 sm:gap-3">
          ...
          <p className="font-mono text-[11px] sm:text-xs text-text-white/95 leading-normal break-words whitespace-normal flex-1">
            {current.message}
            {current.reply && (
